...
Many online development courses use in-browser code editors or "sandboxes," which give you the tools and programs needed to accomplish the task at hand and nothing else. You'll use some of these sandboxes throughout the early stages of this curriculum since they're great for getting started quickly. However, the best way to set yourself up for long-term success is to operate in a real development environment.
...
If you're using a Mac, you're in great shape. This curriculum assumes a Unix-based system. By installing just a few programs, you will be up and running with your education in no time!
...
* **Development Tools Are Built for Linux** - Ruby \(on Rails\) and Node.js, popular backend technologies covered by this curriculum and widely used in the larger web development community, are open source projects that explicitly _expect_ to run on an open-source \(UNIX-based\) platform like Linux.
