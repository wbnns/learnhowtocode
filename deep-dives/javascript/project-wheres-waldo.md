...
Hopefully you got a chance to play "Where's Waldo" \([see here if unfamiliar](http://en.wikipedia.org/wiki/Where%27s_Wally%3F)\) as a kid. You're given a photograph with tons of stuff going on and you're meant to locate several familiar characters.
...
1. Set up a GitHub Repo for this project. Follow the instructions atop the [Google Homepage project](https://www.learnhowtocodebook.com/foundations/frontend/project-create-a-web-page) if you need help.
...
8. Play with it!
9. Push your solution to GitHub, Heroku, and/or Firebase Hosting
